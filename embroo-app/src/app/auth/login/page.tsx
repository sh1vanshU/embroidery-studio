    ...
    <div className="w-full max-w-md">
      <div className="bg-surface rounded-[var(--radius-md)] border border-[var(--border)] p-8 sm:p-10 shadow-[var(--shadow-deep)]">
        ...
        <p className="text-text-secondary text-sm text-center mb-8">
          Sign in to your Embroo account
        </p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              autoComplete="email"
              {...register('email')}
              className="w-full px-4 py-3 rounded-[var(--radius-sm)] bg-charcoal-light border border-[var(--border)] text-text-primary text-sm placeholder:text-text-muted focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold/30 transition-colors"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                {...register('password')}
                className="w-full px-4 py-3 pr-12 rounded-[var(--radius-sm)] bg-charcoal-light border border-[var(--border)] text-text-primary text-sm placeholder:text-text-muted focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold/30 transition-colors"
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="checkbox"
                className="w-4 h-4 rounded border-[var(--border)] bg-charcoal-light accent-gold"
              />
        ...
        <p className="mt-6 text-center text-sm text-text-secondary">
          ...
          <Link href="/auth/register" className="text-gold hover:text-gold-light font-medium transition-colors">
            Register
          </Link>
        </p>
      </div>
